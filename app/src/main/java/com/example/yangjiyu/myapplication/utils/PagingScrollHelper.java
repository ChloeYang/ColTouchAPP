...
import com.example.yangjiyu.myapplication.SourceItemFragment;
...
public class PagingScrollHelper {
    ...
    private int getPageIndex() {
        ...
        if (SourceItemFragment.bIs3ChangeTo2 /*|| SourceItemFragment.bIsChanged*/){
            p=p-SourceItemFragment.last3PageIndex;
        }
        return p;
    }
